...
<body>
    ...
    <table>
        ...
        <tr>
            <td>{!! $juego->id !!}</td>
            <td>{!! $juego->categorias->nombre !!}</td>
            <td>{!! $juego->plataformas->nombre !!}</td>
            <td>{!! $juego->nombre !!}</td>
            <td><img src="{{ asset('../storage/fotografias/' . $juego->imagen) }}" alt="Imagen" width="300"></td>
            <td>{!! $juego->status !!}</td>
            <td>
                <button class="button"><a href="{!! 'juegos/'.$juego->id !!}">Detalle</a></button>               
                <button class="button"><a href="{!! 'juegos/'.$juego->id.'/edit' !!}">Editar</a></button>
